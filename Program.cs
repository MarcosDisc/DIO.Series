...
namespace Series
{
    class Program
    {
        ...
        private static void AtualizarSerie()
        {
            ...
            {
                Console.WriteLine("{00-{1}",i, System.Enum.GetName(typeof(Genero),i));
            }
            ...
            Console.Write("Digite o Ano de inínio da Série: ");
        ...
        private static void ListarSeries()
        {
            ...
            foreach (var serie in lista) {
                var excluido = serie.retornaExcliodo();
        ...
        private static string ObterOpcaoUsuario()
        {
            ...
            Console.WriteLine("1 - Lister Séries");
